...
yStatic  = -55.0   # Static Vehicle Y Position
...
start_w = [xEgoCar, yEgoCar, Wrap_Angle(yawEgo), 0] 
...
planner_params["maxIter"]      = config.maxIter
...
planner_params["samplingtime"] = 0.1             # Sampling time
planner_params["DynamicObs"]   = config.dynamicObs            # Flag to decide dynamic obstacle
planner_params["obstaclesVel"] = config.constantObsVelocity   # Constant velocity of obstacles
