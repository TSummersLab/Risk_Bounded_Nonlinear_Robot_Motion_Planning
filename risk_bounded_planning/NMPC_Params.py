...
class NMPCParams:
    ...
    def __init__(self, sim_params):        
        ...
        self.Q = 100*np.eye(self.num_states) # Q = 1000*np.diag([0.1, 0.5, 0.1, 0.1]) # TODO SET 3RD ELEMENT OF Q TO ZERO
        self.Q[2,2] = 0
        ...
        self.x_min     = -300 # self.boundary[0] - 2.0 # -85.0 -2.0 = -87.0
        self.y_min     = -300 # self.boundary[1] + self.boundary[3] # -85.0
        self.x_max     = 300 # self.boundary[0] + self.boundary[2] + 2.0 # = -73.0       
        self.y_max     = 300 # self.boundary[1] # -43.0  
