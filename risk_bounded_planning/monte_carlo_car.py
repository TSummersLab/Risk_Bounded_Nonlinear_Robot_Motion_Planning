# -*- coding: utf-8 -*-
"""
Created on Mon May 3 14:27:18 2021
...
class World(object):
    ...
    def Restart(self):        
        ...
        print('Waypoints Shape:', self.ref_traj_waypts.shape)
...
class VehicleControl(object):
    ...
    def Parse_Events(self, client, world, clock, ref_iterator): 
        ...
        if ready_to_go:  
            ...
            horizon_ref_states = ref_traj_waypts[:, ref_iterator:ref_iterator+5]   # N = 10             
...
def Game_Loop(args):
    ...
    try:        
        ...
        trial_num = 100 # config.Trial_Num
        print('trial_num:', trial_num)
        file_name = "mc_results_"+str(trial_num)+'.pkl'
        pickle_on = open(os.path.join(SAVEPATH, file_name),"wb")
        pickle.dump(car_tracking_data, pickle_on)
        pickle_on.close()
        
        # Stop the simulation & exit
        pygame.display.quit()
        pygame.quit()
        sys.exit(0)
