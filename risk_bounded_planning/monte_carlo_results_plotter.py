...
def Plotter(start_w, end_w, obst, boundaryInfo):
    ...
    # Plot goal region
    ax.add_artist(Rectangle((end_w[0]-2, end_w[1]-2), 3, 3, lw=4, ls = '--', fc='b', ec='b', alpha = 0.3))    
    # Plot start point
    ax.scatter(start_w[0], start_w[1], s=600, c='goldenrod', marker='^', label='Start', zorder=20, alpha = 0.5)
